...
HLS_SOURCES = ../../../../tb_rv32i_npp_ip.cpp ../../../../rv32i_npp_ip.cpp ../../../../print.cpp ../../../../fetch.cpp ../../../../execute.cpp ../../../../emulate.cpp ../../../../decode.cpp
...
$(ObjDir)/tb_rv32i_npp_ip.o: ../../../../tb_rv32i_npp_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tb_rv32i_npp_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_rv32i_npp_ip.d
