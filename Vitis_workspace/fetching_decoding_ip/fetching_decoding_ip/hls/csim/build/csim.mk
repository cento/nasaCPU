...
HLS_SOURCES = ../../../../testbench_fetching_decoding_ip.cpp ../../../../type.cpp ../../../../statistic_update.cpp ../../../../running_cond_update.cpp ../../../../print.cpp ../../../../immediate.cpp ../../../../fetching_decoding_ip.cpp ../../../../fetch.cpp ../../../../execute.cpp ../../../../decode.cpp
...
$(ObjDir)/statistic_update.o: ../../../../statistic_update.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../statistic_update.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/statistic_update.d

$(ObjDir)/running_cond_update.o: ../../../../running_cond_update.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../running_cond_update.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
