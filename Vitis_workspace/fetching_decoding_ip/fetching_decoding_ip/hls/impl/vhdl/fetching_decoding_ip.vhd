...
architecture behav of fetching_decoding_ip is 
    ...
    "fetching_decoding_ip_fetching_decoding_ip,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=10.423400,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=128,HLS_SYN_DSP=0,HLS_SYN_FF=282,HLS_SYN_LUT=579,HLS_VERSION=2023_2}";
    ...
    signal is_running_running_cond_update_fu_95_ap_return : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal is_running_running_cond_update_fu_95_ap_ready : STD_LOGIC;
    signal pc_1_execute_fu_101_ap_ready : STD_LOGIC;
    signal pc_1_execute_fu_101_d_i_imm_val : STD_LOGIC_VECTOR (16 downto 0);
    signal pc_1_execute_fu_101_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal pc_fu_108_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    port map (
        ...
        instruction => grp_fetch_fu_82_ap_return,
        ap_return_0 => grp_decode_fu_89_ap_return_0,
        ap_return_1 => grp_decode_fu_89_ap_return_1);

    is_running_running_cond_update_fu_95 : component fetching_decoding_ip_running_cond_update
    port map (
        ap_ready => is_running_running_cond_update_fu_95_ap_ready,
        instruction => grp_fetch_fu_82_ap_return,
        ap_return => is_running_running_cond_update_fu_95_ap_return);

    pc_1_execute_fu_101 : component fetching_decoding_ip_execute
    port map (
        ap_ready => pc_1_execute_fu_101_ap_ready,
        pc_val => pc_0_load_reg_147,
        d_i_type_val => grp_decode_fu_89_ap_return_0,
        d_i_imm_val => pc_1_execute_fu_101_d_i_imm_val,
        ap_return => pc_1_execute_fu_101_ap_return);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                ...
                pc_0_fu_64 <= pc_1_execute_fu_101_ap_return;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                pc_0_load_reg_147 <= pc_0_fu_64;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage2_subdone, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage1_subdone)
    begin
        case ap_CS_fsm is
    ...
    ap_condition_pp0_flush_enable_assign_proc : process(is_running_running_cond_update_fu_95_ap_return, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_subdone)
    begin
        if (((is_running_running_cond_update_fu_95_ap_return = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    pc_1_execute_fu_101_d_i_imm_val <= grp_decode_fu_89_ap_return_1(17 - 1 downto 0);
    pc_fu_108_p1 <= start_pc(16 - 1 downto 0);
end behav;
