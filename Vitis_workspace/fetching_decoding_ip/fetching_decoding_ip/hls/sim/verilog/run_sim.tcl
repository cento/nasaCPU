...
if {[file isfile fetching_decoding_ip.autotvin.dat]} {
	file delete -force fetching_decoding_ip.autotvin.dat
}

if {[file isfile fetching_decoding_ip.autotvout.dat]} {
	file delete -force fetching_decoding_ip.autotvout.dat
}
