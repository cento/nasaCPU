; ModuleID = 'C:/Users/monde/Documents/GitHub/nasa-CPU/Vitis_workspace/fetching_ip/fetching_ip/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_fetching_ip_hw(i32 %start_pc, [65536 x i32]* %code_ram_copy)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([65536 x i32]* noalias, [65536 x i32]* noalias readonly) unnamed_addr #4 {
entry:
...
declare void @apatb_fetching_ip_hw(i32, [65536 x i32]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([65536 x i32]* noalias, [65536 x i32]* noalias readonly) unnamed_addr #4 {
entry:
  ret void
}

define void @fetching_ip_hw_stub_wrapper(i32, [65536 x i32]*) #5 {
entry:
  call void @copy_out([65536 x i32]* null, [65536 x i32]* %1)
  %2 = bitcast [65536 x i32]* %1 to i32*
  call void @fetching_ip_hw_stub(i32 %0, i32* %2)
  call void @copy_in([65536 x i32]* null, [65536 x i32]* %1)
  ret void
}
