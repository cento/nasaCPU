...
`define AUTOTB_DUT      fetching_ip
`define AUTOTB_DUT_INST AESL_inst_fetching_ip
`define AUTOTB_TOP      apatb_fetching_ip_top
`define AUTOTB_LAT_RESULT_FILE "fetching_ip.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fetching_ip.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fetching_ip_top
...
`define AUTOTB_TVIN_start_pc_out_wrapc  "../tv/rtldatafile/rtl.fetching_ip.autotvin_start_pc.dat"
`define AUTOTB_TVIN_code_ram_out_wrapc  "../tv/rtldatafile/rtl.fetching_ip.autotvin_code_ram.dat"
module `AUTOTB_TOP;
