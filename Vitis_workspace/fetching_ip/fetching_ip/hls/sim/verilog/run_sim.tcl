...
if {[file isfile fetching_ip.autotvin.dat]} {
	file delete -force fetching_ip.autotvin.dat
}

if {[file isfile fetching_ip.autotvout.dat]} {
	file delete -force fetching_ip.autotvout.dat
}
