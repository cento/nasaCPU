...
/* Definitions for driver FETCHING_IP */
#define XPAR_XFETCHING_IP_NUM_INSTANCES 1

/* Definitions for peripheral FETCHING_IP_0 */
#define XPAR_FETCHING_IP_0_DEVICE_ID 0
#define XPAR_FETCHING_IP_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_FETCHING_IP_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral FETCHING_IP_0 */
#define XPAR_XFETCHING_IP_0_DEVICE_ID XPAR_FETCHING_IP_0_DEVICE_ID
#define XPAR_XFETCHING_IP_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XFETCHING_IP_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
