# 1 "rv32i_npp_ip/rv32i_npp_ip.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
# 1 "rv32i_npp_ip/rv32i_npp_ip.h" 1
# 17 "rv32i_npp_ip/rv32i_npp_ip.h"
...
# 18 "rv32i_npp_ip/rv32i_npp_ip.h" 2
# 102 "rv32i_npp_ip/rv32i_npp_ip.h"
...
# 2 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
# 1 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\ap_int.h" 1
# 3 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
# 1 "rv32i_npp_ip/fetch.h" 1
...
# 4 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
# 1 "rv32i_npp_ip/execute.h" 1
...
# 5 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
# 1 "rv32i_npp_ip/decode.h" 1
...
void decode(
  instruction_t instruction,
  decoded_instruction_t *d_i);
# 6 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
# 1 "rv32i_npp_ip/print.h" 1
# 7 "rv32i_npp_ip/rv32i_npp_ip.cpp" 2
...
__attribute__((sdx_kernel("rv32i_npp_ip", 0))) void rv32i_npp_ip(
  ...
  int data_ram[(1<<16)],
  unsigned int *nb_instruction){
#line 27 "C:/Users/monde/Documents/GitHub/nasa-CPU/HLS/rv32i_npp_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=rv32i_npp_ip
# 24 "rv32i_npp_ip/rv32i_npp_ip.cpp"
...
#pragma HLS ARRAY_PARTITION variable=reg_file dim=1 complete
 instruction_t instruction;
  ...
  unsigned int nbi;
  decoded_instruction_t d_i;
  VITIS_LOOP_38_1: for (int i=0; i<(1<<5); i++) reg_file[i] = 0;
  pc = start_pc;
  nbi = 0;
  VITIS_LOOP_41_2: do{
