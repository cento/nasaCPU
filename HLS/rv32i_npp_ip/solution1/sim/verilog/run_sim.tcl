...
if {[file isfile rv32i_npp_ip.autotvin.dat]} {
	file delete -force rv32i_npp_ip.autotvin.dat
}

if {[file isfile rv32i_npp_ip.autotvout.dat]} {
	file delete -force rv32i_npp_ip.autotvout.dat
}
