...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.rv32i_npp_ip.autotvin_start_pc.dat"
         "c.rv32i_npp_ip.autotvin_code_ram.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.rv32i_npp_ip.autotvout_data_ram.dat"
         "rtl.rv32i_npp_ip.autotvout_nb_instruction.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
