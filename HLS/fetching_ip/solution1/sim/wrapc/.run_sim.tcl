...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fetching_ip.autotvin.dat"
	set constFileTvOut       "fetching_ip.autotvout.dat"
	set constFileHdlTvIn     "fetching_ip.autohdltvin.dat"
	set constFileHdlTvOut    "fetching_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
