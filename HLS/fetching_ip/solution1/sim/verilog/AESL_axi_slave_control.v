        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_start_pc_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    write (start_pc_data_in_addr + write_start_pc_count * four_byte_num * 4 + i * 4, start_pc_data_tmp_reg, write_start_pc_resp);
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_code_ram_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    write (code_ram_data_in_addr + write_code_ram_count * four_byte_num * 4 + i * 4, code_ram_data_tmp_reg, write_code_ram_resp);
