...
# 2 "<built-in>" 2
# 1 "src/fetching_ip.cpp" 2
# 1 "src/fetching_ip.h" 1
...
# 5 "src/fetching_ip.h" 2
# 17 "src/fetching_ip.h"
...
# 4 "src/fetching_ip.cpp" 2
# 1 "src/running_cond_update.h" 1
...
void running_cond_update(
  instruction_t instruction,
  bit_t *is_running);
# 5 "src/fetching_ip.cpp" 2

__attribute__((sdx_kernel("fetching_ip", 0))) void fetching_ip(
  unsigned int start_pc,
  unsigned int code_ram[(1<<16)]){
#line 22 "C:/Users/monde/Documents/GitHub/nasa-CPU/HLS/fetching_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fetching_ip
# 8 "src/fetching_ip.cpp"
