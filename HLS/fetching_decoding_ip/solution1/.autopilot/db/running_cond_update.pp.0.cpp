# 1 "fetching_decoding_ip/src/running_cond_update.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "fetching_decoding_ip/src/running_cond_update.cpp" 2
...
# 5 "fetching_decoding_ip/src/running_cond_update.h" 2


void running_cond_update(
  instruction_t instruction,
  bit_t *is_running);
# 2 "fetching_decoding_ip/src/running_cond_update.cpp" 2
