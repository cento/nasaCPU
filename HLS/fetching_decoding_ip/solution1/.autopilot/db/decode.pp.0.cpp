# 1 "fetching_decoding_ip/src/decode.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "fetching_decoding_ip/src/decode.cpp" 2
# 1 "fetching_decoding_ip/src/debug_fetching_decoding_ip.h" 1
# 2 "fetching_decoding_ip/src/decode.cpp" 2
...
# 3 "fetching_decoding_ip/src/decode.cpp" 2
# 1 "fetching_decoding_ip/src/type.h" 1




type_t type(opcode_t opc);
# 4 "fetching_decoding_ip/src/decode.cpp" 2
# 1 "fetching_decoding_ip/src/immediate.h" 1
...
# 5 "fetching_decoding_ip/src/decode.cpp" 2
