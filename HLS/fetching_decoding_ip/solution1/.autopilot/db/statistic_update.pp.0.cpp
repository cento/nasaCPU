# 1 "fetching_decoding_ip/src/statistic_update.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "fetching_decoding_ip/src/statistic_update.cpp" 2
...
# 5 "fetching_decoding_ip/src/statistic_update.h" 2


void statistic_update(unsigned int *nbi);
# 2 "fetching_decoding_ip/src/statistic_update.cpp" 2
