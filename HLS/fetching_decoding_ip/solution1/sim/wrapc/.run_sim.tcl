...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fetching_decoding_ip.autotvin.dat"
	set constFileTvOut       "fetching_decoding_ip.autotvout.dat"
	set constFileHdlTvIn     "fetching_decoding_ip.autohdltvin.dat"
	set constFileHdlTvOut    "fetching_decoding_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
