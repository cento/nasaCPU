...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "my_adder_ip.autotvin.dat"
	set constFileTvOut       "my_adder_ip.autotvout.dat"
	set constFileHdlTvIn     "my_adder_ip.autohdltvin.dat"
	set constFileHdlTvOut    "my_adder_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
