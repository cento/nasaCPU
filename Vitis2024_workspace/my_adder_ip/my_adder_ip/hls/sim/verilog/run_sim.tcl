...
if {[file isfile my_adder_ip.autotvin.dat]} {
	file delete -force my_adder_ip.autotvin.dat
}

if {[file isfile my_adder_ip.autotvout.dat]} {
	file delete -force my_adder_ip.autotvout.dat
}
