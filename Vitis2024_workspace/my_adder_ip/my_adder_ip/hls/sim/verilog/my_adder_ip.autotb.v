...
`define AUTOTB_DUT      my_adder_ip
`define AUTOTB_DUT_INST AESL_inst_my_adder_ip
`define AUTOTB_TOP      apatb_my_adder_ip_top
`define AUTOTB_LAT_RESULT_FILE "my_adder_ip.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "my_adder_ip.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_my_adder_ip_top
...
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.my_adder_ip.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.my_adder_ip.autotvin_b.dat"
`define AUTOTB_TVOUT_c  "../tv/cdatafile/c.my_adder_ip.autotvout_c.dat"
`define AUTOTB_TVOUT_c_out_wrapc  "../tv/rtldatafile/rtl.my_adder_ip.autotvout_c.dat"
module `AUTOTB_TOP;
