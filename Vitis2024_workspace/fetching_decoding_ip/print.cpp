...
void print_decode(decoded_instruction_t d_i){
    printf("[DECODE] opcode:     %2x [",  (unsigned int)d_i.opcode);
    print_opcode(d_i.opcode);
    printf("]\n");
    printf("[DECODE] rd:         %2x\n",  (unsigned int)d_i.rd);
    printf("[DECODE] func3:       %1x\n", (unsigned int)d_i.func3);
    printf("[DECODE] rs1:        %2x\n",  (unsigned int)d_i.rs1);
    printf("[DECODE] rs2:        %2x\n",  (unsigned int)d_i.rs2);
    printf("[DECODE] func7:      %2x\n",  (unsigned int)d_i.func7);
    print_type(d_i.type);
    printf("\n");
}
