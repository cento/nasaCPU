...
call C:/Xilinx/Vivado/2024.1/bin/xsim --noieeewarnings fetching_decoding_ip -tclbatch fetching_decoding_ip.tcl -view fetching_decoding_ip_dataflow_ana.wcfg -protoinst fetching_decoding_ip.protoinst
