...
set ip_vlnv xilinx.com:hls:fetching_ip:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project fetching_ip
...
dict set report_options topmodule "fetching_ip"
dict set report_options funcmodules {fetching_ip_fetch fetching_ip_execute fetching_ip_running_conditional_update}
dict set report_options bindmodules fetching_ip_control_s_axi
