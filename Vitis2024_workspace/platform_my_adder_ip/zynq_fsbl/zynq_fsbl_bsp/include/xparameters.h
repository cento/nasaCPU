...
#define XPAR_XMY_ADDER_IP_NUM_INSTANCES 1

/* Definitions for peripheral MY_ADDER_IP_0 */
#define XPAR_MY_ADDER_IP_0_COMPATIBLE "xlnx,my-adder-ip-1.0"
#define XPAR_MY_ADDER_IP_0_BASEADDR 0x40000000
#define XPAR_MY_ADDER_IP_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral MY_ADDER_IP_0 */
#define XPAR_XMY_ADDER_IP_0_BASEADDR 0x40000000
#define XPAR_XMY_ADDER_IP_0_HIGHADDR 0x4000ffff
#define XPAR_XMY_ADDER_IP_0_COMPATIBLE "xlnx,my-adder-ip-1.0"
