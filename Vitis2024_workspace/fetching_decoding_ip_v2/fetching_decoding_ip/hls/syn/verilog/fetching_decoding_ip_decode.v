...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if ((1'b1 == ap_condition_134)) begin
            ...
            ap_phi_mux_d_i_imm_write_assign_phi_fu_146_p12 = {{instruction[31:12]}};
...
assign d_imm_inst_11_8_fu_214_p4 = {{instruction[11:8]}};

assign d_imm_inst_31_fu_207_p3 = instruction[32'd31];
...
assign or_ln6_fu_279_p4 = {{instruction[31:20]}};
...
assign tmp_1_fu_248_p4 = {{instruction[31:25]}};

assign tmp_2_fu_257_p4 = {{instruction[11:7]}};

assign tmp_3_fu_223_p4 = {{instruction[30:25]}};

assign tmp_fu_303_p4 = {{instruction[30:21]}};
