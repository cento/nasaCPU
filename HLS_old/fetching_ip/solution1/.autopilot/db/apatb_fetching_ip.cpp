...
extern "C"
void fetching_ip_hw_stub_wrapper(hls::sim::Byte<4>, void*);

extern "C"
void apatb_fetching_ip_hw(hls::sim::Byte<4> __xlx_apatb_param_start_pc, void* __xlx_apatb_param_code_ram)
{
  ...
  port1.param = { __xlx_apatb_param_code_ram };
  port1.depth = { 65536 };
  port1.offset = {  };
