...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rv32i_npp_ip.autotvin.dat"
	set constFileTvOut       "rv32i_npp_ip.autotvout.dat"
	set constFileHdlTvIn     "rv32i_npp_ip.autohdltvin.dat"
	set constFileHdlTvOut    "rv32i_npp_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
