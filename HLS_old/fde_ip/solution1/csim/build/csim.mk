...
HLS_SOURCES = ../../../src/testbench_fde_ip.cpp ../../../src/decode.cpp ../../../src/disassemble.cpp ../../../src/emulate.cpp ../../../src/execute.cpp ../../../src/fde_ip.cpp ../../../src/fetch.cpp ../../../src/immediate.cpp ../../../src/print.cpp ../../../src/type.cpp
...
$(ObjDir)/testbench_fde_ip.o: ../../../src/testbench_fde_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../src/testbench_fde_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
$(ObjDir)/fde_ip.o: ../../../src/fde_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../src/fde_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
